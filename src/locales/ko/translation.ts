const detailsKo = {
  ...
  //About Section Data
  about: [
    '다양한 관점으로 문제를 바라보고, 더 나은 사용자 경험을 고민하며 기능을 만드는 개발자 한정욱입니다.',
    ...
    '기술적 완성도와 사용자 경험을 모두 갖춘 UI/UX 중심의 프론트엔드 개발자로 성장하여, 사용자와 팀 모두에게 신뢰받는 개발자가 되는 것이 저의 목표입니다.',
  ],
  ...
  experiences: [
    {
      ...
      type: '활동',
      result:
        '기획적인 부분과 비즈니스 인사이트를 얻고 또한 문제 해결에 대해서 더 depth있게 고민하는 경험을 했습니다.',
    },
    {

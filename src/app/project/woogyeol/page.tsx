...
export default function WoogyeolProject() {
  ...
  const projectImages = t('woogyeol.projectImages', {
    returnObjects: true,
  }) as ProjectImage[];
  const challenges = t('woogyeol.challenges', {
    returnObjects: true,
  }) as ProjectChallenge[];
  const techStack = t('woogyeol.techStack', {
    returnObjects: true,
  }) as string[];
  const relatedArticles = t('woogyeol.relatedArticles', {
    returnObjects: true,
  }) as RelatedArticle[];
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <>
              <h1 className="text-4xl font-bold">{t('woogyeol.title')}</h1>
              <p className="text-xl mt-2">{t('woogyeol.shortDescription')}</p>
            </>
          </div>
        </div>
      </motion.header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg mb-6 text-gray-700 leading-relaxed">
                {t('woogyeol.detailedDescription')}
              </p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-lg">{t('woogyeol.team')}</p>
              <p className="text-md  mt-2">{t('woogyeol.members')}</p>
            </motion.div>
            <motion.div
              className="text-center"
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <p className="text-md mt-2">{t('woogyeol.mainRole')}</p>
            </motion.div>
          </div>
        </div>
      </motion.section>
